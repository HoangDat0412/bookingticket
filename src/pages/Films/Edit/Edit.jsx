...
import { getInformationFilmActionApi, updateFilmsActionApi } from '../../../redux/reducers/QuanLyFilmsReducer';

const Edit = (props) => {

  const [componentSize, setComponentSize] = useState('default');
  const { thongTinPhim } = useSelector(state => state.quanLyFilmsReducer);
  ...
  useEffect(() => {
    let { id } = param
    console.log("id",id);
    dispatch(getInformationFilmActionApi(id))
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(updateFilmsActionApi(formData))
