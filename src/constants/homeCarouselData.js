const homeCarouselData = [
    {
      hinhAnh: "assets/img/carousel/gai-gia-lam-chieu.jpg",
    ...
    {
      hinhAnh: "assets/img/carousel/lua-deu-gap-lua-dao.jpg",
    ...
    {
      hinhAnh: "assets/img/carousel/than-bip-jack-chot.jpg",
